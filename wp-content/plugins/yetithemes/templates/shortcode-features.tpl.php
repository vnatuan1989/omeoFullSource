...
<div class="features <?php echo esc_attr($short_id); ?> columns-<?php echo absint($per_row); ?><?php if (absint($use_boxed)) echo ' row'; ?>">
    ...
    <?php $i = 0;
    foreach ($yesshop_features as $post): $i++; ?>
        ...
        if (absint($use_boxed)) $class .= ' yeti-row-grid';
        ...
        //if(absint($use_boxed)) $class_inner .= ' yeti-row-grid';
        ?>
            ...
            <div class="<?php echo esc_attr($class_inner); ?>">
                ...
                <div class="feature-sumary">
                    ...
                    <?php if (strcmp($learn_more, 'true') == 0): ?>
                        <p class="learn-more-wrap"><a class="learn-more-link" href="<?php echo esc_url($post->url); ?>"
                                                      title="<?php echo esc_attr(get_the_title()); ?>"><?php echo esc_html($l_text); ?>
                                <i class="<?php echo esc_attr($icon) ?>"></i></a></p>
                    <?php endif; ?>
