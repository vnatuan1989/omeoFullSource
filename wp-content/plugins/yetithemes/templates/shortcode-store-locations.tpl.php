...
if (!empty($stores)):
    ...
    <div class="row">
        ...
        <div class="yeti-shortcode-content yeti-owlCarousel yeti-loading light"
             data-options="<?php echo esc_attr(json_encode($options)); ?>" data-base="1">
                    ...
                    <div class="col-sm-24 location-item">
                        <div class="location-item-inner">
                            <div class="gmap_static_wrapper">
                                <img src="<?php echo esc_url($_gmap_static_link); ?>"
                                     alt="<?php esc_attr_e('Store location map', 'yetithemes') ?>" width="270"
                                     height="170">
                            </div>
                            <div class="store-meta">
                                ...
                                if (!empty($store['link'])) {
                                    $_li_txt = !empty($store['link']['title']) ? esc_html($store['link']['title']) : esc_html__('More infomation', 'yetithemes');
