...
$image = '';
if (!empty($ops['bg_img'])) {
    $image = wp_get_attachment_image($ops['bg_img'], 'yesshop_shop_subcat_large');
}
$desc = '';
                    ...
                    foreach ($product_categories as $category) :
                        ...
                        <li>
                            ...
                            <div class="product-detail">
                                ...
                                <a class="text-color1 text-link"
                                   href="<?php echo esc_url(get_term_link($category->slug, 'product_cat')); ?>"
                                   title="<?php echo esc_attr($category->name); ?>"><?php _e('Show now', 'yetithemes') ?></a>
                            </div>
                        </li>
                    <?php endforeach; ?>
                </ul>
