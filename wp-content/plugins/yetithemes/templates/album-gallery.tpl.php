...
<div class="yeti-gallery-item <?php echo esc_attr(implode(' ', $class)); ?> <?php echo esc_attr(implode(' ', $cats)); ?>"
            ...
            <div class="yeti-meta">
                ...
                if (!empty($galleries)) {
                    ...
                    if (!empty($galleries['att_img'])) {
                        ...
                        $images_str = sprintf(_n('%d image', '%d images', $count, 'yetithemes'), $count);
                    }
                    if (!empty($galleries['v_link'])) {
                        $count = count($galleries['v_link']);
                        $videos_str = sprintf(_n('%d video', '%d videos', $count, 'yetithemes'), $count);
                    }
