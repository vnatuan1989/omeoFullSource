...
class Yetithemes_WooBrands
{
    ...
    {
        $labels = array(
            'name' => _x('Brands', 'taxonomy general name', 'yetithemes'),
            'singular_name' => _x('Brand', 'taxonomy singular name', 'yetithemes'),
            'search_items' => __('Search Brands', 'yetithemes'),
            'popular_items' => __('Popular Brands', 'yetithemes'),
            'all_items' => __('All Brands', 'yetithemes'),
            'parent_item' => null,
            'parent_item_colon' => null,
            'edit_item' => __('Edit Brand', 'yetithemes'),
            'update_item' => __('Update Brand', 'yetithemes'),
            'add_new_item' => __('Add New Brand', 'yetithemes'),
            'new_item_name' => __('New Brand Name', 'yetithemes'),
            'separate_items_with_commas' => __('Separate Brands with commas', 'yetithemes'),
            'add_or_remove_items' => __('Add or remove Brands', 'yetithemes'),
            'choose_from_most_used' => __('Choose from the most used Brands', 'yetithemes'),
            'not_found' => __('No Brand found.', 'yetithemes'),
            'menu_name' => __('Brands', 'yetithemes'),
        );
    ...
    public function add_brand_fields()
    {
        ...
        <div class="form-field">
            <label><?php _e('Thumbnail', 'yetithemes'); ?></label>
            ...
            <div style="line-height: 60px;">
                ...
                <button type="button"
                        class="upload_image_button button"><?php _e('Upload/Add image', 'yetithemes'); ?></button>
                <button type="button"
                        class="remove_image_button button"><?php _e('Remove image', 'yetithemes'); ?></button>
            </div>
    ...
    public function edit_category_fields($term)
    {
        ...
        <tr class="form-field">
            <th scope="row" valign="top"><label><?php _e('Thumbnail', 'yetithemes'); ?></label></th>
            <td>
                <div id="product_brand_thumbnail" style="float: left; margin-right: 10px;"><img
    ...
    public function product_brand_columns($columns)
    {
        ...
        $new_columns['thumb'] = __('Image', 'yetithemes');
    ...
    public function product_brand_column($columns, $column, $id)
    {
        if ('thumb' == $column) {
            ...
            $columns .= '<img src="' . esc_url($image) . '" alt="' . esc_attr__('Thumbnail', 'yetithemes') . '" class="wp-post-image" height="48" width="48" />';
