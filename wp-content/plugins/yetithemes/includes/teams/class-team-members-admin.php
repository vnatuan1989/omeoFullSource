...
if (!class_exists('Yetithemes_TeamMembers_Admin')) {
    ...
    class Yetithemes_TeamMembers_Admin extends Yetithemes_TeamMembers
    {
        ...
        public function tableHeading($columns = array())
        {
            ...
            $args = array(
                ...
                'title' => '',
                'role' => __('Role', 'yetithemes'),
            );
            $columns = array_merge($args, $columns);
            $columns['title'] = __('Name', 'yetithemes');
            return $columns;
        }
    ...
    new Yetithemes_TeamMembers_Admin();
}
