(function (c) {
    ...
    var p = -1, f = -1, g = function (a) {
        ...
        var b = {
            byRow: !0, property: "height",
            target: null, remove: !1
        };
    ...
    b._apply = function (a, e) {
        var d = m(e), h = c(a), k = [h], l = c(window).scrollTop(), f = c("html").outerHeight(!0), n = h.parents().filter(":hidden");
        n.each(function () {
            var a = c(this);
    ...
    b._applyDataApi = function () {
        ...
        c("[data-match-height], [data-mh]").each(function () {
            var b =
                c(this), d = b.attr("data-mh") || b.attr("data-match-height");
