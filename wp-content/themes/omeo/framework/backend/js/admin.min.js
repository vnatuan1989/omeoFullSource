(function($){
	...
	var NTH_AD = {
		...
		mediaUpload: function(){
			$(document).on('click','.yeti_upload_image_button',function(event){
				event.preventDefault();
				var $_this = $(this);
				var title = $_this.parents('.yeti_upload_image').data('f_title');
				var text = $_this.parents('.yeti_upload_image').data('f_btext');
				...
				file_frame.on( 'select', function() {
					...
					$_this.parents('.yeti_upload_image').find('.nth_image_id').val( attachment.id );
					...
					$_this.parents('.yeti_upload_image').find('.yeti_thumbnail img').attr('src', src_ );
					$_this.parents('.yeti_upload_image').find('.yeti_remove_image_button').removeClass('hidden');
				});
			...
			$( document ).on( 'click', '.yeti_remove_image_button', function( event ) {
				event.preventDefault();
				$(this).parents('.yeti_upload_image').find('.yeti_thumbnail img').attr('src', yesshop_data.media.images.f_default );
				$(this).parents('.yeti_upload_image').find('.nth_image_id').val( '' );
				$(this).parents('.yeti_upload_image').find('.yeti_remove_image_button').addClass('hidden');
			});
		...
		sidebarCreating: function () {
			...
			sidebarForm.on('submit', function(e){
				e.preventDefault();
				var data =  {
					'action':'yesshop_add_widgetsidebar',
			...
			$('.sidebar-yeti-custom-sidebar-arrow').find('.sidebar-name-arrow').before('<div class="delete-sidebar ready"><i class="dashicons-trash dashicons-before"></i></div>');
			...
			$('#widgets-right').on('click', '.delete-sidebar.ready', function(e){
				...
				var data =  {
					'action':'yesshop_del_widgetsidebar',
