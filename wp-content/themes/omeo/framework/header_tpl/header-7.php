    ...
    <div class="container">
        <div class="row">
            <div class="yt-display-table">
                <div class="col-sm-8 col-md-6 yt-display-table-cell">
                    <?php Yesshop_Functions()->headerShippingText();?>
                </div>
                <div class="col-sm-8 col-md-12 yt-display-table-cell"><?php Yesshop_Functions()->getLogo(); ?></div>
                <div class="col-sm-8 col-md-6 right-area yt-display-table-cell">
