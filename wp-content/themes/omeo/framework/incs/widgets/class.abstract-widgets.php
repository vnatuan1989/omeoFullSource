 ...
 * @extends  WP_Widget
 */
abstract class Yesshop_Widget extends WP_Widget
{
    ...
    public function __construct()
    {
        ...
        parent::__construct($this->widget_id, "YETI &ndash; " . $this->widget_name, $widget_ops);
        ...
        foreach ($this->settings as $key => $setting) {
            ...
            switch ($setting['type']) {
                ...
                case 'textarea':
                    ...
                    <p>
                        <label for="<?php echo esc_attr($this->get_field_id($key)); ?>"><?php echo esc_html($setting['label']); ?></label>
                        <textarea rows="8" class="widefat" id="<?php echo esc_attr($this->get_field_id($key)); ?>"
                                  name="<?php echo esc_attr($this->get_field_name($key)); ?>"><?php echo wp_kses($value, wp_kses_allowed_html('post')); ?></textarea>
                    </p>
                    <?php
                    break;
                ...
                case 'attach_image' :
                    ...
                    <div style="margin: 10px 0;">
                        <label for="<?php echo esc_attr($this->get_field_id($key)); ?>"><?php echo esc_html($setting['label']); ?></label>
                        <div style="margin-top: 5px;" class="yeti_upload_image"
                             data-f_title="<?php esc_attr_e('Choose an image', 'omeo'); ?>"
                             data-f_btext="<?php esc_attr_e('Use image', 'omeo'); ?>">

                            <div class="yeti_thumbnail" style="float:left;margin-right:10px;">
                            ...
                            <div style="line-height:28px;">
                                <input type="hidden" class="nth_image_id"
                                       name="<?php echo esc_attr($this->get_field_name($key)); ?>"
                                       id="<?php echo esc_attr($this->get_field_id($key)); ?>"
                                       value="<?php echo esc_attr($value); ?>"/>
                                <button type="submit"
                                        class="yeti_upload_image_button button"><?php esc_html_e('Add image', 'omeo'); ?></button>
                                <button style="<?php echo esc_attr($dis_none_remove); ?>"
                                        class="yeti_remove_image_button button"><?php esc_html_e('Remove', 'omeo'); ?></button>
                            </div>
                        </div>
                        <div class="clear"></div>
                    </div>
