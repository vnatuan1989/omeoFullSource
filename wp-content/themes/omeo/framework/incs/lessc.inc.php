    ...
    protected function lib_unit($arg) {
        if ($arg[0] == "list") {
            ...
            return array("number", $this->assertNumber($number),
                $this->compileValue($this->libE($newUnit)));
        } else {
    ...
    protected function reduce($value, $forExpression = false) {
        switch ($value[0]) {
            case "interpolate":
                ...
                if (empty($value[2])) $res = $this->libE($res);
            ...
            case "variable":
                ...
                if (is_array($key)) {
                    $key = $this->reduce($key);
                    $key = $this->vPrefix . $this->compileValue($this->libE($key));
                }
...
class Yesshop_Less_Compiler
{
    ...
    {
        $this->less_dir = THEME_DIR . 'less/';
        $this->css_dir = THEME_DIR . 'css/';
    }

    public function compile($less_name = 'custom')
    {
        $less_file = $this->less_dir . $less_name . '.less';
        $css_file = $this->css_dir . $less_name . '.css';
