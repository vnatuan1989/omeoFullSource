    ...
    class ReduxFramework_import_font extends ReduxFramework
    {
        ...
        function render()
        {
            ...
            <div class="nth-redux-import-export">
                <button class="nth-import-btn button button-primary"
                        data-assign="<?php echo esc_attr($this->field['id']) ?>"><i
                            class="el el-upload"></i> <?php esc_html_e('Import', 'omeo'); ?></button>
                <input type="file" data-file_exists="<?php echo absint($xml_exist); ?>" class="nth-import-input-file"
                       data-filename="<?php echo esc_attr($filename) ?>" data-action="yesshop_import_font_xml"
                       style="display: none;" id="<?php echo esc_attr($this->field['id']) ?>" name="nth_import_font"/>
            </div>
            <?php
        }
