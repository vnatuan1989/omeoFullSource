...
add_action('tgmpa_register', 'yesshop_register_required_plugins');
/**
 ...
 */
function yesshop_register_required_plugins()
{
    /*
    ...
    $__down_yeti_uri = 'http://demo.nexthemes.com/wordpress/downloads/plugins/';

    $plugins = array(
        // This is an example of how to include a plugin bundled with a theme.
        array(
            'name' => 'YetiThemes extra', // The plugin name.
            'slug' => 'yetithemes', // The plugin slug (typically the folder name).
            'source' => get_theme_file_path('framework/incs/plugins/yetithemes.zip'), // The plugin source.
        ...
        array(
            ...
            'required' => false, // If false, the plugin is only 'recommended' instead of required.
            'version' => '3.16.20', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
            'force_activation' => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
            'external_url' => '', // If set, overrides default API URL and points to an external URL.
            'is_callable' => '', // If set, this callable will be be checked for availability to determine if a plugin is active.
     ...
     */
    $config = array(
        'id' => 'yesshop_tgmpa',                 // Unique ID for hashing notices for multiple instances of TGMPA.
