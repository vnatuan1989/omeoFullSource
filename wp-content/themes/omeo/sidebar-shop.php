...
extract(Yesshop_Functions()->pages_sidebar_act('shop'));
?>

<?php if (strlen($_left_class) > 0): ?>
    <div id="sidebar_left" class="sidebar-shop yeti-sidebar <?php echo esc_attr($_left_class); ?>" role="complementary">
...
<?php if (strlen($_right_class)): ?>
    <div id="sidebar_right" class="sidebar-shop yeti-sidebar <?php echo esc_attr($_right_class); ?>">
